...
@{
    ...
    Copyright              = '(c) 2023 w159. All rights reserved.  Licensed with GNU GENERAL PUBLIC LICENSE.'
    ...
    PrivateData            = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = '[Publish] - Update WinSCP Core to v6.1.1.'
